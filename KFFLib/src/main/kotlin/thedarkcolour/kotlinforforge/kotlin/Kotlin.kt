 ...
 */
public fun <T> supply(value: T): Supplier<T> = Supplier { value }

/**
 * Returns an empty new [EnumMap].
 */
public inline fun <reified K : Enum<K>, V> enumMapOf(): MutableMap<K, V> = EnumMap(K::class.java)
 ...
 */
public inline fun <reified E : Enum<E>> enumSet(): EnumSet<E> = EnumSet.noneOf(E::class.java)
 ...
 * @see enumSetOf
 */
public fun <E : Enum<E>> enumSetOf(
    e1: E,
    e2: E,
): EnumSet<E> = EnumSet.of(e1, e2)
...
public fun <E : Enum<E>> enumSetOf(
    ...
    e3: E,
    e4: E,
): EnumSet<E> = EnumSet.of(e1, e2, e3, e4)
...
public fun <E : Enum<E>> enumSetOf(
    ...
    e4: E,
    e5: E,
): EnumSet<E> = EnumSet.of(e1, e2, e3, e4, e5)
...
public fun <E : Enum<E>> enumSetOf(
    first: E,
    vararg rest: E,
): EnumSet<E> = EnumSet.of(first, *rest)
